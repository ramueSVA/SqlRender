    ...
    fluidRow(
      ...
      column(width = 3,
             box(background = "light-blue",
                 ...
                 selectInput("dialect", NULL, choices = c("BigQuery", "Impala", "Netezza", "Oracle", "PDW", "PostgreSQL", "RedShift", "SQL Server", "SQLite", "Hive", "Spark", "Snowflake", "Dremio", "Synapse", "InterSystems IRIS" = "iris"), selected = "SQL Server"),
